...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView colorss = (TextView) findViewById(R.id.colors);
        TextView phrasess = (TextView) findViewById(R.id.phrases);
        ...
        phrasess.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
